package at.campus02.AlgorithmenDatenstrukturen.Heap.UE09_RestaurantMaxHeap;

public class RestaurantMaxHeap
{
    private at.campus02.AlgorithmenDatenstrukturen.Heap.UE09_RestaurantMaxHeap.Restaurant[] restaurants;
    private int count = 0;
    ...
    {
        restaurants = new at.campus02.AlgorithmenDatenstrukturen.Heap.UE09_RestaurantMaxHeap.Restaurant[size];
    }
    ...
    {
        at.campus02.AlgorithmenDatenstrukturen.Heap.UE09_RestaurantMaxHeap.Restaurant temp;
    ...
    public boolean insert(at.campus02.AlgorithmenDatenstrukturen.Heap.UE09_RestaurantMaxHeap.Restaurant newRestaurant)
    {
        if (isFull())
        {
    ...
    public at.campus02.AlgorithmenDatenstrukturen.Heap.UE09_RestaurantMaxHeap.Restaurant remove()
    {
        at.campus02.AlgorithmenDatenstrukturen.Heap.UE09_RestaurantMaxHeap.Restaurant resultRestaurant;
        if (count == 0)
        {
